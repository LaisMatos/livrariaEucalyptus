...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/styleAdmUser.css"> 
...
<body>
    ...
    <main id="conteudo">
        ...
        <section id="addContato">
                ...
                <div id="form">
                    <form name="admUsuario" method="Post" action="router.php?identificador=usuario&action=inserir">
                        
                        <span>Nome:</span> 
                        <input type="text" name="txtusuario" size="100" maxlength="30">

                        <span>Login:</span> 
                        <input type="text" name="txtemail" size="60" maxlength="30">

                        <span>Senha:</span> 
                        <input type="password" name="senha" size="60" maxlength="30">      
            ...
            <div id="consultaDeDados">
                ...
                ?>
                    ...
                    <td class="tblColunas registros">
                        ...
                        <a onclick="return confirm('Deseja excluir este item?');" href="router.php?identificador=usuario&action=deletar&idusuario=<?=$item['idusuario']?>"> 
